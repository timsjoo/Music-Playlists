...
const AllPlaylists = (props) => {  
    ...
    useEffect(() => {
        axios.get(`http://localhost:8000/api/playlists`)       //Playlists
            .then((res) => {
                console.log(res);
    ...
    const deleteHandler = (idFromBelow) =>{
        axios.delete(`http://localhost:8000/api/playlists/${idFromBelow}`)      //DELETE Playlist
    ...
    useEffect(() => {
        axios.get(`http://localhost:8000/api/users`,   // Get LoggedInUser
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                                ...
                                                <div className="btn-group my-1">
                                                    ...
                                                    <button className="btn btn-outline-success me-2" type="button" onClick = {() => navigate (`/playlist/edit/${playlist._id}`)}>Edit</button>
                                        
                                                    <button className="btn btn-outline-success me-2" type="button" onClick={() => deleteHandler(playlist._id)}>Delete</button>
